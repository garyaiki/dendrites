	...
	settings(
		...
		libraryDependencies ++= Seq(
	     ...
	     "com.typesafe.akka" %% "akka-remote" % "2.4.4",
		   ...
		   "com.typesafe.akka" %% "akka-testkit" % "2.4.4" % "it,test",
       ...
       "com.typesafe.akka" % "akka-http-experimental_2.11" % "2.4.4",
			 "com.typesafe.akka" % "akka-stream-testkit_2.11" % "2.4.4",
       "com.typesafe.akka" % "akka-http-spray-json-experimental_2.11" % "2.4.4",
			 "com.typesafe.akka" % "akka-http-testkit_2.11" % "2.4.4",
