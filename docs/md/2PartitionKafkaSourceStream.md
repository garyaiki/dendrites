Multiple Kafka [TopicPartitions](kafka.apache.org/0100/javadoc/org/apache/kafka/common/TopicPartition.html) can be polled, records for each partition can be processed in parallel.
