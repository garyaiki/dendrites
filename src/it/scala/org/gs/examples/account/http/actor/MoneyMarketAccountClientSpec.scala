...
import org.gs.examples.account.{MoneyMarketAccountBalances, GetAccountBalances}

/**
  *
  * @author Gary Struthers
  */
class MoneyMarketAccountClientSpec extends TestKit(ActorSystem("test")) with ImplicitSender
          with WordSpecLike {
