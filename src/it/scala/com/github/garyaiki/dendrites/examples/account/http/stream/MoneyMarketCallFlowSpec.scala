...
/**
  ...
  */
class MoneyMarketCallFlowSpec extends WordSpecLike with Matchers with BeforeAndAfter with BalancesProtocols {
  ...
  before { // init connection pool
    ...
    def partial = typedQueryResponse(baseURL, "GetAccountBalances", caseClassToGetQuery, mapPlain, mapMoneyMarket) _
  ...
  def badPartial = typedQueryResponse(badBaseURL, "GetAccountBalances", caseClassToGetQuery, mapPlain, mapMoneyMarket) _
