...
class ParallelApproximatorsSpec extends WordSpecLike with TestValuesBuilder {
  ...
  "A BigDecimals ParallelApproximators" should {
    "update all agents and return their latest values" in {
      ...
      val approximators = new ParallelApproximators[BigDecimal](avgAgent,
        cmsAgent,
        dvAgent,
        hllAgent,
        qtAgent,
      ...
      val composite = approximators.approximators
  ...
  "A BigInt ParallelApproximators" should {
    "update all agents and return their latest values" in {
      ...
      val approximators = new ParallelApproximators[BigInt](avgAgent,
        cmsAgent,
        dvAgent,
        hllAgent,
        qtAgent,
  ...
  "A Double ParallelApproximators" should {
    "update all agents and return their latest values" in {
      ...
      val approximators = new ParallelApproximators[Double](avgAgent,
        cmsAgent,
        dvAgent,
        hllAgent,
        qtAgent,
  ...
  "A Float ParallelApproximators" should {
    "update all agents and return their latest values" in {
      ...
      val approximators = new ParallelApproximators[Float](avgAgent,
        cmsAgent,
        dvAgent,
        hllAgent,
        qtAgent,
  ...
  "A Int ParallelApproximators" should {
    "update all agents and return their latest values" in {
      ...
      val approximators = new ParallelApproximators[Int](avgAgent,
        cmsAgent,
        dvAgent,
        hllAgent,
        qtAgent,
  ...
  "A Long ParallelApproximators" should {
    "update all agents and return their latest values" in {
      ...
      val approximators = new ParallelApproximators[Long](avgAgent,
        cmsAgent,
        dvAgent,
        hllAgent,
        qtAgent,
