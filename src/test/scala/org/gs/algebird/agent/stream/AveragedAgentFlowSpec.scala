...
/**
  ...
  *
  */
class AveragedAgentFlowSpec extends FlatSpecLike with TestValuesBuilder {
  ...
  "An AveragedAgentFlow of BigDecimals" should "update its AveragedValue" in {
  ...
  "An AveragedAgentFlow of Doubles" should "update its AveragedValue" in {
  ...
  "An AveragedAgentFlow of Floats" should "update its AveragedValue" in {
